...
class layout_Default_html_6f6ee0a8eab4f0cadafefd838138608cf5e9654b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output3 .= '
    ...
    <footer id="page-footer" class="bp-page-footer">
        <div class="container footer-container">
            ...
            <div class="about-us footer-box">
                ...
                <ul>
                    ...
                    <li><a href="/ueber-uns/jobs">Job</a></li>
        ...
        <div class="handala-container">
            <div class="container">
                <p>© 2022 Samariterbund Leopoldstadt</p>
                <p>by <a target="_blank" href="https://handala-design.com">Handala-design</a></p>
            </div>
        </div>
    </footer>
    ';
