...
class partial_LoginNews_a50d28405783ce8142b0b4e979ce76483f90ef96 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output13 .= '<p class="text-muted"><span class="sr-only">';
...
$output101 .= '<p class="text-muted"><span class="sr-only">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
